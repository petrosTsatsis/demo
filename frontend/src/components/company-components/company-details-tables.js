...
const CompanyDetailsTables = () => {
  const { id } = useParams();
  // the company entity extends the customer entity in the backend so we can use the customer's methods as companys
  ...
  // call these methods to find the company's biggest purchase, latest certificate and latest license
  useEffect(() => {
  ...
  // find company's biggest purchase by findind the purchase with the biggest id
  ...
  // find company's latest certificate which is the one with the biggest id
  ...
  // find company's latest license which is the one with the biggest id
  ...
  return (
    ...
    >
      <div className="container-md">
              ...
              <thead>
                <tr>
                  <th
                    ...
                    className="tasks-in-progress"
                  >
                    {customer.name}'s SSL Certificates
                  </th>
                </tr>
                <tr>
        ...
        <Row className="mt-4" style={{ marginBottom: "50px" }}>
          <Col
            style={{ width: "100%", paddingRight: "12px", paddingLeft: "0" }}
          >
            <table
              ...
              <thead>
                <tr>
                  <th
                    ...
                    className="tasks-in-progress"
                  >
                    {customer.name}'s Software Licenses
                  </th>
                </tr>
                <tr>
                  <th style={{ width: "10%" }} scope="col">
...
export default CompanyDetailsTables;
